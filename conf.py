...
parser.add_argument('--video', action='store_true', help='flag to indicate input is video')

# Param
parser.add_argument('-b','--batch-size', default=15, type=int, metavar='N', help='mini-batch size (default: 128)')
...
parser.add_argument('-j', '--num_workers', default=5, type=int, metavar='N', help='number of data loading workers (default: 4)')
